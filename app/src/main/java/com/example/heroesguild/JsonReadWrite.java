...
public class JsonReadWrite {
    ...
    public static List<HeroTemplate> loadHeroTemplates(Context context) {
...
//            JSONArray list = new JSONArray(data);
    ...
    public static List<String> loadMaleNames(Context context) {
    ...
    public static List<String> loadFemaleNames(Context context) {
